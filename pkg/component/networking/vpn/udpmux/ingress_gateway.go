...
var (
	//go:embed charts/udpmux/udpmux
	chartIngress     embed.FS
	chartPathIngress = filepath.Join("charts", "udpmux", "udpmux")
)

// UdpMuxValues holds values for the udpmux chart.
type UdpMuxValues struct {
	...
	// Ports is a list of all Ports the udp-mux is listening on.
